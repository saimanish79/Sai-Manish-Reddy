...
public class WardenView {
	...
	@Autowired
	WardenActiveGatepass wardenActiveGatepass;
...
//			errorhandler_tabsheet.addTab(errors.createComponent(), "Errors", FontAwesome.CLOSE,2);
			gatepassHandler_tabsheet.addTab(wardenActiveGatepass.createComponent(user),"Active Gatepasses",FontAwesome.CUBE,0);
			gatepassHandler_tabsheet.addTab(wardenGatepassDetails.createComponent(user),"All Gatepasses",FontAwesome.CUBE,0);
