...
//import com.example.demo.ui.AttendanceView;
//import com.example.demo.ui.DetailsView;
//import com.example.demo.ui.MarksView;
//import com.example.demo.ui.StudentView.StudentHandler;
...
//			errorhandler_tabsheet.addTab(errors.createComponent(), "Errors", FontAwesome.CLOSE,2);
			gatepassHandler_tabsheet.addTab(gatepassdetailsView.createComponent(user),"GatepassDetails",FontAwesome.CUBE,0);
			gatepassHandler_tabsheet.addTab(gatepassform.createComponent(user),"GatepassForm",FontAwesome.CUBE,1);
